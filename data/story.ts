...
export const storyData: Scene[] = [
  {
    ...
    imagePosition: "right",
    lines: [
      { type: 'narration', text: 'A quiet village night. Three boys lie on a flat rooftop, stars glittering overhead.' },
      ...
      { type: 'narration', text: 'The boys giggle.' },
      ...
      { type: 'narration', text: 'Camera pans upward toward the glowing Milky Way.' },
  ...
  },
  {
    ...
    imagePosition: "left",
    lines: [
      { type: 'narration', text: 'The rooftop fades away; the screen fills with a golden sphere swirling with fiery loops.' },
      ...
      { type: 'narration', text: 'Massive arcs of plasma burst across the surface.' },
      ...
      { type: 'narration', text: 'And here\'s something cool — the Sun follows an 11-year rhythm called the solar cycle. Every cycle, it gets super active and even flips its magnetic poles, like turning itself inside out!' },
      { type: 'narration', text: 'Flares twist like fiery dragons.' },
  ...
  },
  {
    ...
    imagePosition: "right",
    lines: [
      { type: 'narration', text: 'Earth surrounded by shimmering blue magnetic lines—like a glowing force field.' },
      ...
      { type: 'narration', text: 'Solar wind particles dash toward Earth and bend around the field lines.' },
      ...
      { type: 'narration', text: 'Auroras ripple across the sky.' },
  ...
  },
  {
    ...
    imagePosition: "left",
    lines: [
      { type: 'narration', text: 'The auroras fade into rolling green farmland. Tractors and drones hover above crops.' },
      ...
      { type: 'narration', text: 'A GPS map flickers; a tractor veers slightly off course.' },
  ...
  },
  {
    ...
    imagePosition: "right",
    lines: [
      { type: 'narration', text: 'Clouds and a jetliner soaring near glowing auroras.' },
      ...
      { type: 'narration', text: 'A cockpit radio crackles.' },
      { type: 'stage', text: 'Pilot (audio): Control, we\'re losing connection—rerouting south!' },
  ...
  },
  {
    ...
    imagePosition: "left",
    lines: [
      { type: 'narration', text: 'The International Space Station orbiting Earth.' },
      ...
      { type: 'narration', text: 'An astronaut floats into a shielded room as particles flash outside.' },
  ...
  },
  {
    ...
    imagePosition: "right",
    lines: [
      { type: 'narration', text: 'Monitors blink; graphs spike.' },
      ...
      { type: 'narration', text: 'A warning flashes: Geomagnetic Storm Alert.' },
  ...
  },
  {
    ...
    imagePosition: "left",
    lines: [
      { type: 'narration', text: 'A bustling city full of screens, phones, satellites.' },
      ...
      { type: 'narration', text: 'A satellite\'s panels shake; phone signals distort; screens freeze.' },
  ...
  },
  {
    ...
    imagePosition: "right",
    lines: [
      { type: 'narration', text: 'A futuristic space-weather observatory.' },
      ...
      { type: 'narration', text: 'Satellites act like space-weather reporters—spotting trouble early and sending warnings to Earth before anyone else can see it.' },
      { type: 'narration', text: 'A scientist clicks a button; alerts pop up: "Airlines," "Power Grids," "Agriculture."' },
  ...
  },
  {
    ...
    imagePosition: "left",
    lines: [
      { type: 'narration', text: 'A massive solar flare races toward Earth.' },
      ...
      { type: 'narration', text: 'The wave bends, bursts into auroras again.' },
  ...
  },
  {
    ...
    imagePosition: "right",
    lines: [
      { type: 'narration', text: 'The auroras fade; the kids reappear under the stars.' },
  ...
  },
  {
    ...
    imagePosition: "left",
    lines: [
      { type: 'narration', text: 'The sky glows orange; birds chirp.' },
      ...
      { type: 'narration', text: 'They laugh as the Sun rises over the hills.' },
      ...
      { type: 'narration', text: 'The boys burst out laughing as their faces glow in the sunrise.' },
      { type: 'narration', text: 'Camera pulls back — three tiny spots of light under a massive golden sky.' },
